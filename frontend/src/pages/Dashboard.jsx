...
import { FiUpload, FiDownload, FiClock, FiSettings, FiTrash2, FiUser, FiLock, FiCamera } from 'react-icons/fi';
...
const Dashboard = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    // Simulate profile update (you'll need to add this to your backend)
    setTimeout(() => {
            ...
            <div className="p-6">
              ...
              {activeTab === 'bookmarks' && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">Save your favorite resources for quick access</p>
                </div>
              )}
